...
void dut_scenarios::bl_1s19_t::bl_1s19_trace2csv(bool_t is_collision)
{
	/* Actors */
...
void dut_scenarios::bl_1s19_t::end_of_run() {
    /* Open a file for writing in append mode.*/
	std::ofstream outfile;
	outfile.open("bl_1s19_trace.csv", std::ios_base::app);
